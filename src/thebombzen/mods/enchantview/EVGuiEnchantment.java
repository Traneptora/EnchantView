...
public class EVGuiEnchantment extends GuiEnchantment {
	...
	public static final ResourceLocation enchantingTableGuiTextures = ThebombzenAPI.getPrivateField(null,
		...
		"field_147078_C",
		"C" });
	public static final ResourceLocation enchantingTableBookTextures = ThebombzenAPI.getPrivateField(null,
			GuiEnchantment.class, new String[] {
	...
	public void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
	        ...
	        float f3 = this.field_147076_A + (this.field_147080_z - this.field_147076_A) * par1;
